...
(function ($, window, document) {
	...
	******************************************************************************/
	var defaults = {
		...
		button_SIZE_TOUCH_DEVICE: 0,				//Button width and height (in pixels) on touch devices
		...
		***********************************************************/
		...
		if (!this.bu_icon) {
			...
			if (this.bu_icon == 'none') {
				this.bu_icon = 'assets/img/icons.png';
			}
			testOb.remove();
		}		
		...
		this.$image.hide();	
		this.imgList = [
			{loaded: false, src: this.bu_icon || 'assets/img/icons.png'}, //Icon image
